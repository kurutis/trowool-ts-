...
export const QuantityModal: React.FC<QuantityModalProps> = ({
    ...
    const [selectedColor, setSelectedColor] = useState<string>(product.colors[selectedColorIndex]);
        ...
        <div className={s.modal}>
            <div className={s.modal_content}>
                ...
                <div className={s.qalenity}>
                    <button className={s.minus} onClick={handleDecrease}>-</button>
                    <input
                        className={s.number}
                        type="number"
                        value={quantity}
                    ...
                    />
                    <button className={s.plus} onClick={handleIncrease}>+</button>
                </div>
                <h2>Выберите цвет</h2>
